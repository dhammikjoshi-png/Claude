...
const SCENES = {
  ...
  greenvale: {
    ...
    decorations: [
      ...
      { type: "fence", x: 160, y: 10, solid: true },
      { type: "fence", x: 192, y: 10, solid: true },
      { type: "fence", x: 232, y: 10, solid: true },
      { type: "fence", x: 264, y: 10, solid: true },
      { type: "lantern", x: 200, y: 24, solid: false },
      { type: "lantern", x: 244, y: 24, solid: false },
    ],
    exits: [
